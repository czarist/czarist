...
Full Stack Software Engineer with 8+ years building web applications, REST APIs, and management systems (CRM/CMS). Hands-on with **PHP (Laravel)**, **Java (Spring Boot)**, and **Python (FastAPI/Flask)** on the backend, **Vue.js** and **React** on the front-end. Lately exploring how AI fits into real engineering workflows — OpenAI, Gemini, Anthropic, LangChain, MCP.
